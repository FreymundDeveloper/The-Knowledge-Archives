  ...
  <div class="article-admin">
    <b-form>
      ...
      <b-form-group label="Name:" label-for="article-name">
        <b-form-input id="article-name" type="text" v-model="article.name" :readonly="mode === 'remove'"
            required placeholder="Enter the article name">
        </b-form-input>
      </b-form-group>
      <b-form-group label="Description:" label-for="article-description">
        <b-form-input id="article-description" type="text" v-model="article.description" :readonly="mode === 'remove'"
            required placeholder="Enter the article description">
        </b-form-input>
      </b-form-group>
      <b-form-group v-if="mode === 'save'" 
        label="Image (URL):" label-for="article-imageUrl">
        <b-form-input id="article-imageUrl" type="text" v-model="article.imageUrl" :readonly="mode === 'remove'"
            required placeholder="Enter the article Url image">
        </b-form-input>
      </b-form-group>
      ...
      <b-form-group v-if="mode === 'save'"
          ...
          <VueEditor v-model="article.content" placeholder="Enter the content of the article" />
      </b-form-group>
    ...
    methods: {
        ...
        loadArticle(article, mode = 'save') {
            ...
            axios.get(`${baseApiUrl}/articles/${article.id}`)
              .then(res => this.article = res.article = res.data)
        },
        loadCategories() {
